...
<head>
    ...
    <title>Pourvoirie Lac Du Cerf</title>
...
<div>
    <a href="#" alt="reserver"><h4>RÉSERVEZ MAINTENANT</h4></a>
    <a href="#" id="toggle" alt="menu"><span  class="iconify" data-inline="false" data-icon="clarity:menu-line" style="color: #141a26; font-size: 32px;"></span></a>
</div>
</header>
...
<section class="contenu">
    ...
    <article>
        <a href="#">
       <img src="images/item-img.png" alt="châlets"/>
            <div>
            <h2>CHÂLETS</h2>
        </div>
        </a>
    ...
    <article>
        <a href="#">
            <img src="images/item-img.png" alt="VTT"/>
        <div>
            <h2>VTT / MOTONEIGE</h2>
        </div>
        </a>
...
<section class="pub">
    <div class="left-side">
        ...
        <div>
            ...
            <a href="#" alt="reserver">Réserver maintenant!</a>
        </div>
    </div>
    <div class="right-side"><img src="#" alt="pub"></div>
</section>
